    ...
    <div class="main-container">
        ...
        <section class="header-section">
            <div class="header-left">
                ...
                <p class="tagline">药学专业 · 理学学士 · 7年质量管理经验 · 期望城市：珠海 · 期望薪资：13-17K</p>
            </div>
        ...
        <div class="cards-grid">
            ...
            <div class="card card-info">
                ...
                <ul class="info-list">
                    ...
                    <li class="info-item">
                        <span class="info-icon">📍</span>
                        <span class="info-value">中国 · 珠海</span>
                    </li>
                </ul>
            ...
            <div class="card card-industry">
                ...
                <ul class="industry-list">
                    <li class="industry-item">
                        ...
                        <div class="ind-desc">无菌注射剂、粉针剂、片剂生产质量管理，GMP合规监控</div>
                    </li>
                    <li class="industry-item">
                        <div class="ind-title">⚗️ 化工行业</div>
                        <div class="ind-desc">食品生物化工（发酵工艺）、汽车粉末材料（AA级客户审核）</div>
                    </li>
                    <li class="industry-item">
                        <div class="ind-title">🪑 家具行业</div>
                        <div class="ind-desc">木质家具、板式家具、金属家具、软体家具体系管理</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="card card-achievements">
                ...
                <ul class="achieve-list">
                    <li class="achieve-item">
                        ...
                        <span>客户方、监管部门、第三方审核通过率<span class="highlight-num">100%</span></span>
                    </li>
                    <li class="achieve-item">
                        <span class="achieve-icon">📋</span>
                    ...
                    <li class="achieve-item">
                        <span class="achieve-icon">💰</span>
                        <span>2024年度认证认可检验检测综合成本较上一年度<span class="highlight-num">降低15万元</span></span>
                    </li>
                    <li class="achieve-item">
                        <span class="achieve-icon">🎯</span>
                    ...
                    <li class="achieve-item">
                        <span class="achieve-icon">🏆</span>
                        <span>体系审核、AA客户审核、清真犹太产品认证<span class="highlight-num">一次性通过</span></span>
                    </li>
                </ul>
            </div>
            ...
            <div class="card card-cert">
                ...
                <div class="cert-section">
                    ...
                    <div class="cert-tags">
                        ...
                        <span class="cert-tag">IATF16949</span>
                    </div>
                </div>
                <div class="cert-section">
                    <div class="cert-label">🏷️ 产品认证</div>
                    <div class="cert-tags">
                        <span class="cert-tag gold">UL</span>
                        ...
                        <span class="cert-tag gold">国际标准产品标志</span>
                    </div>
                </div>
                <div class="cert-section">
            ...
            <div class="card card-skills">
                ...
                <div class="skill-category">
                    ...
                    <div class="skill-tags">
                        ...
                        <span class="skill-tag">IATF16949</span>
                        <span class="skill-tag">PDCA</span>
                        <span class="skill-tag">CAPA</span>
                        <span class="skill-tag">8D报告</span>
                        <span class="skill-tag">AQL抽样</span>
                    </div>
                </div>
                <div class="skill-category">
                    ...
                    <div class="skill-tags">
                        ...
                        <span class="skill-tag">体系推行</span>
                        <span class="skill-tag">内审员梯队建设</span>
                        <span class="skill-tag">管理评审</span>
                ...
                <div class="skill-category">
                    ...
                    <div class="skill-tags">
                        ...
                        <span class="skill-tag">RNN循环网络</span>
                        <span class="skill-tag">深度神经网络</span>
                        <span class="skill-tag">数据标注模型</span>
                    </div>
                </div>
                <div class="skill-category">
                    <div class="skill-cat-label">📜 内审员资质</div>
                    <div class="skill-tags">
                        ...
                        <span class="skill-tag">BRCGS内审员</span>
                        <span class="skill-tag">CCAA注册审核员</span>
                    </div>
                </div>
            </div>
